...
cat > /tmp/render_pet_icon.swift << 'SWIFT'
import Cocoa
...
NSColor(calibratedRed: 0.90, green: 0.49, blue: 0.13, alpha: 1.0).setFill()
...
if let data = rep.representation(using: .png, properties: [:]) {
    try? data.write(to: URL(fileURLWithPath: "/tmp/pet_icon_1024.png"))
}
SWIFT

swift /tmp/render_pet_icon.swift
SRC="/tmp/pet_icon_1024.png"
